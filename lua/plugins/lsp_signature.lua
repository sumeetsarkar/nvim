local cfg = {
  ...
  max_width = 160, -- max_width of signature floating_window
  ...
  floating_window_off_y = -8, -- adjust float windows y position. e.g -2 move window up 2 lines; 2 move down 2 lines
